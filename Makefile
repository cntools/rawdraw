...
vk/cnfgvert.h : vk/cnfg.glsl
	-glslangValidator -S vert -DVERT --target-env vulkan1.3 -o $@ -x $^

vk/cnfgbatch.h : vk/cnfg.glsl
	-glslangValidator -S frag -DBATCH --target-env vulkan1.3 -o $@ -x $^

vk/cnfgimg.h : vk/cnfg.glsl
	-glslangValidator -S frag -DIMG --target-env vulkan1.3 -o $@ -x $^

rawdraw_sf.h : tools/single_file_creator CNFG.h tools/rawdraw_http_page.h vk/cnfgvert.h vk/cnfgbatch.h vk/cnfgimg.h
	...
	./tools/single_file_creator CNFG.h CNFG.c CNFGWinDriver.c CNFGEGLLeanAndMean.c CNFGRasterizer.c CNFGEGLDriver.c CNFGWASMDriver.c CNFGXDriver.c CNFGFunctions.c CNFGOGL.c CNFG3D.c CNFGAndroid.h CNFGHTTP.c CNFGVK.c vk/cnfgbatch.h vk/cnfgimg.h vk/cnfgvert.h tools/rawdraw_http_page.h >> $@
...
# Some people may not have glslangValidator on their system, so have another clean target
...
cleanvkshader : clean
	rm -rf vk/cnfgvert.h vk/cnfgbatch.h vk/cnfgimg.h
